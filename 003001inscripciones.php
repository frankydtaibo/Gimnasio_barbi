...
<html lang="en">
  ...
  ?> 
    ...
    <div class="panel-heading">
        ...
        <button type='button' class="btn btn-success" data-toggle="modal" data-target="#nuevo_plan"><span class="glyphicon glyphicon-plus" ></span> Nueva inscripción</button>
      </div>
      <h4><i class='icon-validacion icono-titulo'></i> Inscripciones</h4>
    </div>      
